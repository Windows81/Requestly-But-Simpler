...
import { cacheRecordedSessionOnClientPageUnload, getTabSession, handleSessionRecordingOnClientPageLoad, initSessionRecordingSDK, launchUrlAndStartRecording, onSessionRecordingStartedNotification, onSessionRecordingStoppedNotification, startRecordingExplicitly, stopRecording, watchRecording, } from "../sessionRecording";
import { initCustomWidgets } from "../customWidgets";
import { getAPIResponse } from "../apiClient";
import { requestProcessor } from "../requestProcessor";
import { handleTestRuleOnClientPageLoad, launchUrlAndStartRuleTesting, saveTestRuleResult, } from "../testThisRuleHandler";
import ruleExecutionHandler from "../ruleExecutionHandler";
import { isExtensionEnabled, isUrlInBlockList } from "../../../utils";
import { globalStateManager } from "../globalStateManager";
import { isProxyApplied } from "../proxy";
import { connectToDesktopAppAndApplyProxy, disconnectFromDesktopAppAndRemoveProxy, checkIfDesktopAppOpen, } from "../desktopApp/index";
        ...
        switch (message.action) {
            ...
            case EXTENSION_MESSAGES.TOGGLE_EXTENSION_STATUS:
                ...
                updateExtensionStatus(message.newStatus)
                    ...
                    console.log("[messageHandler.handleToggleExtensionStatus] Error occurred while updating extension status.", {
                        error: e.message,
                        extensionIconState: extensionIconManager.getState(),
                        message,
                    });
