...
var MenuItem;
(function (MenuItem) {
    MenuItem["TOGGLE_ACTIVATION_STATUS"] = "toggle-activation-status";
})(MenuItem || (MenuItem = {}));
var ToggleActivationStatusLabel;
(function (ToggleActivationStatusLabel) {
    ToggleActivationStatusLabel["ACTIVATE"] = "Activate Requestly";
    ToggleActivationStatusLabel["DEACTIVATE"] = "Deactivate Requestly";
})(ToggleActivationStatusLabel || (ToggleActivationStatusLabel = {}));
export const updateActivationStatus = (isExtensionEnabled) => {
...
export const initContextMenu = async () => {
    ...
    chrome.contextMenus.onClicked.addListener(async (info) => {
        if (info.menuItemId === MenuItem.TOGGLE_ACTIVATION_STATUS) {
            ...
            await setVariable(Variable.IS_EXTENSION_ENABLED, extensionStatus);
