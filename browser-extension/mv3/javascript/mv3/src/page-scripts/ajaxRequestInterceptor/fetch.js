import { applyDelay, getAbsoluteUrl, getCustomRequestBody, getFunctionFromCode, getMatchedDelayRule, getMatchedRequestRule, getMatchedResponseRule, isContentTypeJSON, isJSON, isPromise, jsonifyValidJSONString, notifyOnBeforeRequest, notifyRequestRuleApplied, notifyResponseRuleApplied, shouldServeResponseWithoutRequest, } from "./utils";
export const initFetchInterceptor = (debug) => {
    ...
    fetch = async (...args) => {
        ...
        try {
            ...
            const requestRule = canRequestBodyBeSent &&
            ...
            if (requestRule) {
                ...
                const requestBody = getCustomRequestBody(requestRule, {
