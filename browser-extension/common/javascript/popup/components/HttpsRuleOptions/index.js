...
export const HttpsRuleOptions = () => {
    ...
    return (React.createElement("div", { className: "https-rule-options-container popup-body-card" },
        React.createElement("div", { className: "title" }, "Intercept and modify HTTP(s) requests"),
        React.createElement("div", { className: "options" }, ruleList.map(({ icon, title, editorLink, tooltipTitle, ruleType }, index) => (React.createElement(Tooltip, { key: index, color: "#000000", placement: "top", title: tooltipTitle, overlayClassName: "action-btn-tooltip" },
            React.createElement(PrimaryActionButton, { block: true, icon: icon, onClick: () => {
                    sendEvent(EVENT.RULE_CREATION_WORKFLOW_STARTED, { rule_type: ruleType });
                    window.open(editorLink, "_blank");
                } }, title))))),
        React.createElement("div", { className: "view-more-options-link", onClick: () => {
