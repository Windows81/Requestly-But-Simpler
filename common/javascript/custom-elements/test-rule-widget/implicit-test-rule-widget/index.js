...
class RQImplicitTestRuleWidget extends RQTestRuleWidget {
    #appliedRules = [];
    #widgetDisplayTimerId;
    #widgetDisplayStartTime;
    ...
    pauseWidgetTimer() {
        if (this.#widgetDisplayTimerId) {
            ...
            this.#widgetDisplayRemainingTime = Math.abs(this.#widgetDisplayRemainingTime - (Date.now() - this.#widgetDisplayStartTime));
