...
A cursory browse through the code-base tells you that it's built atop lots of TypeScript tools. It uses React for GUIs, which then gets tightly packaged using Rollup.
...
My changes mainly consist of re-arranging modules, though I did have to transpile and re-write some TypeScript code using `tsc`.
